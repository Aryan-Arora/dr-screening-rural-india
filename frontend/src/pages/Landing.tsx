...
export function Landing() {
  ...
  return <div ref={page} className="landing">
    ...
    <section className="trust section-shell"><div><p className="eyebrow">EXPLAINABILITY / GRAD-CAM INSPIRED</p><h2>DON’T JUST<br />TRUST THE SCORE.<br /><em>UNDERSTAND WHY.</em></h2></div><div className="trust-flow">
        <div className="flow-node"><span className="flow-index" /><span>ORIGINAL RETINAL IMAGE</span></div>
        <span className="flow-connector" />
        <div className="flow-node"><span className="flow-index" /><span>AI ATTENTION</span></div>
        <span className="flow-connector" />
        <div className="flow-node"><span className="flow-index" /><span>HIGHLIGHTED REGIONS</span></div>
        <span className="flow-connector" />
        <div className="flow-node"><span className="flow-index" /><span>EXPLAINABLE RESULT</span></div>
      </div></section>
...
function SeverityVisual() { return <div className="severity"><div className="severity-line"><span className="severity-dot" /></div><div className="severity-labels"><span>NO DR</span><span>MILD</span><span className="active">MODERATE</span><span>SEVERE</span><span>PDR</span></div></div> }
